...
class SolutionModelTests(TestCase):
    ...
    def test_solution_creation(self):
        ...
        self.assertEqual(self.solution.content, '# Test Content\n\nThis is a test solution.')
        ...
        self.assertIn('<h1>Test Content</h1>', self.solution.content_html)
...
class SolutionVersionModelTests(TestCase):
    ...
    def test_version_creation(self):
        ...
        self.assertEqual(self.initial_version.content, '# Initial Content\n\nThis is the initial version.')
...
class SolutionFormTests(TestCase):
    ...
    def test_solution_form_save(self):
        ...
        self.assertEqual(solution.tags.count(), 2)
...
class SolutionViewTests(TestCase):
    ...
    def test_solution_list_view_with_search(self):
        """Test that the solution list view can search solutions."""
        response = self.client.get(reverse('solutions:list') + '?q=solution 1')
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'Solution 1')
        self.assertNotContains(response, 'Solution 2')
    ...
    def test_solution_detail_view(self):
        ...
        response = self.client.get(reverse('solutions:detail', kwargs={'slug': self.solution1.slug}))
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'Solution 1')
        self.assertContains(response, '<h1>Solution 1</h1>')
    ...
    def test_solution_detail_view_unpublished(self):
        ...
        response = self.client.get(reverse('solutions:detail', kwargs={'slug': self.unpublished_solution.slug}))
